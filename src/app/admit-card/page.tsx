      ...
      <div className="container">
        <div className="header-search-row">
          <div className="page-header">
            <h1>Admit Cards</h1>
            <p>Download admit cards, hall tickets, and check examination schedules.</p>
          </div>
          ...
          <table className="jobs-table" id="jobsTable">
            <thead>
              <tr>
                ...
                <th style={{ width: '160px' }}>Admit Card</th>
                  ...
                  <tr key={item.id}>
                    ...
                    <td data-label="Board">
                      <div className="board-col cell-value">
                        ...
                        <span className="board-full-name">({item.boardFull})</span>
                      </div>
                    </td>
                    <td className="post-name-col" data-label="Post Name">
                      <span className="cell-value">{item.title}</span>
                    </td>
                    <td className="eligibility-col" data-label="Scheduled Date">
                      <span className="cell-value">{item.lastDate}</span>
                    </td>
                    <td className="last-date-col" data-label="Admit Card">
                      <span className="cell-value" style={{ color: '#059669', fontWeight: 700 }}>{item.status}</span>
                    </td>
                    <td className="action-col" data-label="More">
                      <Link href={`/jobs/${item.id}`} className="btn-view">
                        View Details
                      </Link>
                    </td>
                  </tr>
