      ...
      <div className="container">
        <div className="header-search-row">
          <div className="page-header">
            <h1>Results</h1>
            <p>Check scorecards, cutoff marks, and final selection merit lists.</p>
          </div>
              ...
              {filteredItems.length > 0 ? (
                filteredItems.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="eligibility-col" data-label="Result Status">
                      <span className="cell-value" style={{ color: '#4f46e5', fontWeight: 700 }}>{item.status}</span>
                    </td>
