      ...
      <div className="container">
        <div className="header-search-row">
          <div className="page-header">
            <h1>Answer Keys</h1>
            <p>Check official answer keys, question papers, and objection windows.</p>
          </div>
              ...
              {filteredItems.length > 0 ? (
                filteredItems.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="eligibility-col" data-label="Answer Key Status">
                      <span className="cell-value" style={{ color: '#d97706', fontWeight: 700 }}>{item.status}</span>
                    </td>
