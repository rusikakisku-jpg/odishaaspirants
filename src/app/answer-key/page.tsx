          ...
          <table className="jobs-table" id="jobsTable">
            <thead>
              <tr>
                ...
                <th>Key Type</th>
                <th style={{ width: '160px' }}>Objection Deadline</th>
              ...
              {loading ? (
                <tr>
                  <td colSpan={6} className="no-records">
                    Loading answer keys from Cloudflare D1...
                  </td>
                </tr>
                ...
                filteredItems.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td data-label="Key Type" className="eligibility-col">
                      <span className="cell-value">{item.qualification}</span>
                    </td>
                    <td data-label="Deadline" className="last-date-col">
